...
!(function (t, e) {
  ...
  function _(t) {
    ...
    if (c || f) {
      var h = s(t);
      (c -= d(h, "x")), (f -= d(h, "y")), (r.width -= c), (r.height -= f);
    }
    return m(r);
  }
  function v(t, e) {
    ...
    return (
      (n ? e.contains(a) : e === a && "BODY" !== a.nodeName) &&
        (d = (function (t, e) {
          var n =
  ...
  function E(t) {
    var e = t.nodeName;
    return (
      "BODY" !== e && "HTML" !== e && ("fixed" === s(t, "position") || E(a(t)))
    );
  }
  function b(t, e, n, i) {
    var r = { top: 0, left: 0 },
  ...
  for (
    var W = (function (t) {
          ...
          f = (function () {
            ...
            return (
              ...
              (r._getRootElement = function (e) {
                var n = W.getSelectorFromElement(e),
                  i = !1;
                return (
                  n && (i = t(n)[0]), i || (i = t(e).closest("." + a)[0]), i
                );
              }),
              ...
              (r._removeElement = function (e) {
                var n = this;
                t(e).removeClass(c),
                  W.supportsTransitionEnd() && t(e).hasClass(l)
                    ? t(e)
                        .one(W.TRANSITION_END, function (t) {
      ...
      B = (function (t) {
          ...
          m = (function () {
            ...
            return (
              (r.toggle = function () {
                var e = !0,
                  n = !0,
                  i = t(this._element).closest(h)[0];
                if (i) {
                  var r = t(this._element).find(u)[0];
                  if (r) {
                    if ("radio" === r.type)
                      if (r.checked && t(this._element).hasClass(a)) e = !1;
                      else {
                        var o = t(i).find(d)[0];
                        o && t(o).removeClass(a);
                      }
                    if (e) {
                      if (
                        ...
                        return;
                      (r.checked = !t(this._element).hasClass(a)),
                        t(r).trigger("change");
                    }
                    r.focus(), (n = !1);
                  }
              ...
              (e._jQueryInterface = function (i) {
                return this.each(function () {
                  var r = t(this).data(n);
                  r || ((r = new e(this)), t(this).data(n, r)),
                    "toggle" === i && r[i]();
                });
              }),
              i(e, null, [
        ...
        return (
          t(document)
            .on(g.CLICK_DATA_API, f, function (e) {
              e.preventDefault();
              var n = e.target;
              t(n).hasClass(l) || (n = t(n).closest(p)),
                m._jQueryInterface.call(t(n), "toggle");
            })
            .on(g.FOCUS_BLUR_DATA_API, f, function (e) {
          ...
          T = (function () {
            ...
            return (
              ...
              (T._getConfig = function (t) {
                return (t = r({}, a, t)), W.typeCheckConfig(e, t, l), t;
              }),
              ...
              (T._slide = function (e, n) {
                var i,
                  ...
                  f = n || (a && this._getItemByDirection(e, a)),
                ...
                if (
                  ...
                  if (
                    ...
                    W.supportsTransitionEnd() && t(this._element).hasClass(m)
                      ? (t(f).addClass(r),
                        W.reflow(f),
                        t(a).addClass(i),
                        t(f).addClass(i),
              ...
              (s._dataApiClickHandler = function (e) {
                var i = W.getSelectorFromElement(this);
                if (i) {
                  var o = t(i)[0];
                  if (o && t(o).hasClass(p)) {
            ...
            return (
              ...
              (s.show = function () {
                ...
                if (!this._isTransitioning && !t(this._element).hasClass(f)) {
                  ...
                  if (
                    (this._parent &&
                      ((i = t.makeArray(
                        t(this._parent).children().children(m.ACTIVES)
                      )).length ||
                        (i = null)),
                    !(i && (r = t(i).data(n)) && r._isTransitioning))
                  ) {
                    ...
                    if (
                      ...
                      i &&
                        (o._jQueryInterface.call(t(i), "hide"),
                        r || t(i).data(n, null));
                      ...
                      var l = function () {
                        t(e._element).removeClass(u).addClass(h).addClass(f),
                          (e._element.style[a] = ""),
                          e.setTransitioning(!1),
                          t(e._element).trigger(c.SHOWN);
                      };
                      if (W.supportsTransitionEnd()) {
                        var p = "scroll" + (a[0].toUpperCase() + a.slice(1));
                        t(this._element)
                          .one(W.TRANSITION_END, l)
                          .emulateTransitionEnd(600),
              ...
              (s._addAriaAndCollapsedClass = function (e, n) {
                if (e) {
                  ...
                  n.length && t(n).toggleClass(d, !i).attr("aria-expanded", i);
                }
              }),
    ...
    if (V && navigator.userAgent.indexOf(Q[G]) >= 0) {
      Y = 1;
      break;
    }
  var q =
        ...
        arrow: {
          ...
          fn: function (t, e) {
            ...
            var r = t.placement.split("-")[0],
              ...
              p = c ? "bottom" : "right",
              g = C(i)[f];
            l[p] - g < a[u] && (t.offsets.popper[u] -= a[u] - (l[p] - g)),
              l[u] + g > a[p] && (t.offsets.popper[u] += l[u] + g - a[p]),
              (t.offsets.popper = m(t.offsets.popper));
            var _ = l[u] + l[f] / 2 - g / 2,
              v = s(t.instance.popper),
              E = parseFloat(v["margin" + h], 10),
              b = parseFloat(v["border" + h + "Width"], 10),
              y = _ - t.offsets.popper[u] - E - b;
            return (
              (y = Math.max(Math.min(a[f] - g, y), 0)),
              (t.arrowElement = i),
              (t.offsets.arrow =
                ((n = {}), $(n, u, Math.round(y)), $(n, d, ""), n)),
              t
            );
          },
          element: "[x-arrow]",
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            var s = void 0 !== o ? o : e.gpuAcceleration,
              ...
              g = void 0;
            if (
              ((g = "bottom" === h ? -a.height + f.bottom : f.top),
              (p = "right" === u ? -a.width + f.right : f.left),
              s && d)
            )
              ...
              var m = "bottom" === h ? -1 : 1,
                v = "right" === u ? -1 : 1;
              (l[h] = g * m), (l[u] = p * v), (l.willChange = h + ", " + u);
            }
            var E = { "x-placement": t.placement };
            return (
              (t.attributes = tt({}, E, t.attributes)),
              (t.styles = tt({}, l, t.styles)),
          ...
          fn: function (t) {
            return (
              ...
              t.arrowElement &&
                ...
                R(t.arrowElement, t.arrowStyles),
              t
            );
          },
    ...
    ot = (function () {
      function t(e, n) {
        ...
        Z(this, t),
          ...
          (this.options = tt({}, t.Defaults, r)),
          (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
          (this.reference = e && e.jquery ? e[0] : e),
          (this.popper = n && n.jquery ? n[0] : n),
          (this.options.modifiers = {}),
          Object.keys(tt({}, t.Defaults.modifiers, r.modifiers)).forEach(
            function (e) {
          ...
          return (
              ...
              if (!this._element.disabled && !t(this._element).hasClass(c)) {
                ...
                if ((s._clearMenus(), !n)) {
                  ...
                  if ((t(e).trigger(r), !r.isDefaultPrevented())) {
                    ...
                    "ontouchstart" in document.documentElement &&
                      !t(e).closest(b).length &&
                      t("body").children().on("mouseover", null, t.noop),
                      this._element.focus(),
                      this._element.setAttribute("aria-expanded", !0),
                      t(this._menu).toggleClass(f),
                      t(e).toggleClass(f).trigger(t.Event(l.SHOWN, i));
                  }
                }
              }
            }),
            ...
            (v._getConfig = function (n) {
              return (
                ...
                W.typeCheckConfig(e, n, this.constructor.DefaultType),
                n
              );
            }),
                    ...
                    if (
                      ...
                      t(o).trigger(u),
                        u.isDefaultPrevented() ||
                          ...
                          t(h).removeClass(f),
                          t(o).removeClass(f).trigger(t.Event(l.HIDDEN, c)));
                    }
                  }
                }
            }),
    ...
    at = (function (t) {
        ...
        g = (function () {
          ...
          return (
            ...
            (g.hide = function (e) {
              ...
              if (
                ...
                if (
                  ...
                  this._isShown = !1;
                  var r =
                    W.supportsTransitionEnd() && t(this._element).hasClass(u);
            ...
            (g._getConfig = function (t) {
              return (t = r({}, s, t)), W.typeCheckConfig("modal", t, a), t;
            }),
            (g._showElement = function (e) {
              var n = this,
                i = W.supportsTransitionEnd() && t(this._element).hasClass(u);
            ...
            (g._showBackdrop = function (e) {
              ...
              if (this._isShown && this._config.backdrop) {
                var r = W.supportsTransitionEnd() && i;
                if (
      ...
      return (
        t(document).on(l.CLICK_DATA_API, p.DATA_TOGGLE, function (n) {
          var i,
            o = this,
            s = W.getSelectorFromElement(this);
          s && (i = t(s)[0]);
          ...
          return (
            ...
            (T.show = function () {
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                var r = this.getTipElement(),
                  o = W.getUID(this.constructor.NAME);
                r.setAttribute("id", o),
                ...
                W.supportsTransitionEnd() && t(this.tip).hasClass(p)
                  ? t(this.tip)
            ...
            (T.hide = function (e) {
              ...
              t(this.element).trigger(r),
                r.isDefaultPrevented() ||
                  ...
                  W.supportsTransitionEnd() && t(this.tip).hasClass(p)
                    ? t(i).one(W.TRANSITION_END, o).emulateTransitionEnd(150)
                    : o(),
                  (this._hoverState = ""));
            }),
            (T.update = function () {
            ...
            (T._enter = function (e, n) {
              ...
              (n = n || t(e.currentTarget).data(i)) ||
                ...
                t(n.getTipElement()).hasClass(g) || n._hoverState === h
                  ? (n._hoverState = h)
          ...
          return (
            ...
            (g._getConfig = function (n) {
              if ("string" != typeof (n = r({}, a, n)).target) {
                ...
                i || ((i = W.getUID(e)), t(n.target).attr("id", i)),
                  (n.target = "#" + i);
              }
              return W.typeCheckConfig(e, n, l), n;
            }),
            ...
            (g._activate = function (e) {
              ...
              var i = t(n.join(","));
              i.hasClass(f)
                ? (i.closest(u.DROPDOWN).find(u.DROPDOWN_TOGGLE).addClass(h),
                  i.addClass(h))
                : (i.addClass(h),
                  i
          ...
          return (
            (n.show = function () {
              ...
              if (
                ...
                var n,
                  i,
                  o = t(this._element).closest(h)[0],
                  l = W.getSelectorFromElement(this._element);
                if (o) {
                  var c = "UL" === o.nodeName ? d : u;
                  i = (i = t.makeArray(t(o).find(c)))[i.length - 1];
                }
                var f = t.Event(r.HIDE, { relatedTarget: this._element }),
            ...
            (n._activate = function (e, n, i) {
              var r = this,
                ...
                s = i && W.supportsTransitionEnd() && o && t(o).hasClass(l),
                a = function () {
                  return r._transitionComplete(e, o, i);
                };
              o && s
                ? t(o).one(W.TRANSITION_END, a).emulateTransitionEnd(150)
                : a();
            }),
